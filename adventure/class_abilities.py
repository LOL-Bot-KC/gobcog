            ...
            if c.heroclass["cooldown"] + cooldown_time <= time.time():
                ...
                if good:
                    if textroll == 1 or textroll == 4:
                        await smart_embed(
                            ctx,
                            _("{skill} {c} this is text case 1 for 1 or 5 roll value{skill}").format(
                        ...
                        await smart_embed(
                            ctx,
                            _("{skill} {c} this is test case 2 with 2 or 6 roll value{skill}").format(
                                c=bold(ctx.author.display_name),
                                skill=self.emojis.skills.berserker
                            ), 
                    )
                        ...
                        await smart_embed(
                            ctx,
                            _("{skill} {c}this is test case 3 with 3 or 7 roll value{skill}").format(
                                c=bold(ctx.author.display_name),
                    ...
                    if session.no_monster:
                        ...
                        # elif roll >= 0.7: (don't need this anymore either)
                            # msg += _("This monster is **a{attr} {challenge}**.\n").format(
                                # challenge=session.challenge,
                                # attr=session.attribute,
                            # )
                            # if roll >= physical_roll2:
                        ...
                        if roll < 0.99:
                            ...
                            if roll >= physical_roll and not roll >= physical_roll2:
                                if pdef >= 1.5:
                            ...
                            if roll >= magic_roll and not roll >= magic_roll2:
                                if mdef >= 1.5:
                            ...
                            if roll >= diplo_roll and not roll >= diplo_roll2:
                                if cdef >= 1.5:
                                    msg += _(
